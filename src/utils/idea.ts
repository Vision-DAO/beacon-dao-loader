 ...
 */
export const instanceOfPayload = (object: object): object is schema.Payload =>
	"start" in object;

/**
 * Checks that an object provides a loader for a WASM module.
 */
export const instanceOfPayloadLoader = (
	object: object
): object is schema.PayloadLoader => "default" in object;
...
export class IdeaMetaProvider implements MetaProvider {
	...
	stream(
		cache: IPFSCache
	): (listener: (e: schema.IdeaMetadata) => void) => void {
